	...
	for (var i = 0; i < 11; i++) {
		...
		for (var j=0; j < 10; j++) {
			if (i === currentRow && j === currentCol) {
				content += "<td width='70'>";
				content += "<img src='https://media.giphy.com/media/dQzfKaSF0aprE3cDXs/giphy.gif' width='70'>";
            } else if (labyrinth[i][j] === 1) {
                content += "<td width='50'>";
				content += "<img src='twinkle.gif' width='50'>";
            } else{
				content += "<td width='70'>";
				content += "<img src='snowflake.gif' width='70'>"
			}
			content += "</td>";
		}
